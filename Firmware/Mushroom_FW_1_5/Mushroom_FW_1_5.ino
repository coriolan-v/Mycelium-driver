...
void onDmxFrame(uint16_t universe, uint16_t length, uint8_t sequence, uint8_t* data) {
  ...
  if (universe == 20) {
    for (int i = 0; i < 100; i++) {
      ...
      winchPosition_raw[i] = data[i * 3];
      //Serial.print(winchPosition_raw[i]);
      //Serial.print("/");
      if (winchPosition_raw[i] == 255) {
        winchPosition = i;
        //Serial.print("__");
        //Serial.print(i);
        //Serial.print("__");
        //Serial.print("/");
       // Serial.println(winchPosition);
        break;
      }
    }
  }
