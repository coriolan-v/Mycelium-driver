...
byte pinList[numPins] =   {
  ...
  37, 38, 39, 40, 41, 32, 14, 15, // only 7 because pin 13 is skipped
...
void setup() {
  ...
  Serial.print("maxUniverses: "); Serial.println(maxUniverses);
...
void onDmxFrame(uint16_t universe, uint16_t length, uint8_t sequence, uint8_t* data) {
  ...
  Serial.print(", l: "); Serial.print(length);
  Serial.print(", s: "); Serial.print(sequence);
